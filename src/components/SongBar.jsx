...
const SongBar = ({ song, index, artistId, isPlaying, activeSong, handlePauseClick, handlePlayClick }) => (
  <div className={`w-full flex flex-row items-center hover:bg-[#4c426e] ${activeSong?.title === song?.title ? 'bg-white/5 backdrop-blur-sm' : 'bg-transparent'} py-2 p-4 rounded-lg cursor-pointer mb-2`}>
